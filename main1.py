...
class Window(QtGui.QWidget):
    ...
    def start(self):
        a = subprocess.Popen(r'c:\Python27\python.exe ' + ' ' + str(os.path.join(os.getcwd(), 'apachelogparser.py')))
    ...
    def startCommand(self):
        try:
            self.process.start(r"c:\Python27\python.exe", QtCore.QStringList(["parserlog.py"]))
